        ...
        <div class="row-2">
            ...
            <div class="row-delivery">
                <div class="row-3">
                    ...
                    <div class="ship">
                        <div class="grid-item"><img src="{{('/source/img/GHN.jpg')}}" alt="GHN"></div>
                        <div class="grid-item"><img src="{{('/source/img/tietkiem.jpg')}}" alt=""></div>
                        <div class="grid-item"><img src="{{('/source/img/ninja.jpg')}}" alt="ninja"></div>
                        <div class="grid-item"><img src="{{('/source/img/shipchung.jpg')}}" alt="chung"></div>
                        <div class="grid-item"><img src="{{('/source/img/viettle.jpg')}}" alt="viettel"></div>
                        <div class="grid-item"><img src="{{('/source/img/logo-vn-post.jpg')}}" alt="vn-post"></div>
                    </div>
                </div>
                ...
                <div class="row-4">
                    ...
                    <div class="ship">
                        <div class="grid-item"><img src="{{('/source/img/logo-acb.jpg')}}" alt="acb"></div>
                        <div class="grid-item"><img src="{{('/source/img/logo-techcombank.jpg')}}"
                                alt="logo-techcombank"></div>
                        <div class="grid-item"><img src="{{('/source/img/logo-vib.jpg')}}" alt="logo-vib"></div>
                        <div class="grid-item"><img src="{{('/source/img/logo-vcb.jpg')}}" alt="logo-vcb"></div>
                        <div class="grid-item"><img src="{{('/source/img/logo-paypal.jpg')}}" alt="logo-paypal"></div>
                        <div class="grid-item"><img src="{{('/source/img/logo-mastercard.jpg')}}" alt="logo-mastercard">
                        </div>
                    </div>
                </div>
            </div>
