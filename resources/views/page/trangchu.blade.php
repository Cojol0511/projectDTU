      ...
      <div class="table-content">
        ...
        <div class="product" id="tab-new">
          ...
          <div class="product-details">
            <div class="product-img">
              <div>
                <a href="#" class="img-re">
                <img src="source/img/{{$new->image}}" alt="new product 1">
                </a>
              <div class="shopping-cart-icon"><a onclick="AddCart({{$new->id}})" href="javscrip:"><i class="fas fa-shopping-cart"></i></a></div>
              </div>
            </div>
        ...
        <div class="product" id="tab-discount">
          ...
          <div class="product-details">
            <div class="product-img">
              <div>
                <a href="#"><img src="source/img/product-16-470x470.jpg" alt="new product 1"></a>
              </div>
              <div class="shopping-cart-icon"><a href=""><i class="fas fa-shopping-cart"></i></a></div>
            </div>
