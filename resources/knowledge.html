...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../public/css/knowledge.css">
  <title>Mona</title>
    ...
    <table>
      ...
      <div class="list-news">
        <div class="item-new">
              <div>
                <a href="#"><img class="img-news"
                    src="../public/imgs/menu-products3.jpg" alt="news">
                </a>
              </div>
            <div class="title-new">
        ...
        <div class="item-new">
            ...
            <div>
              <a href="#"><img class="img-news" src="../public/imgs/59406586_277022679721039_6026262764271054419_n.jpg"
                  alt="news"></a>
            </div>
            <div class="title-new">
        ...
        <div class="item-new">
            ...
            <div>
              <a href="#"><img class="img-news" 
                src="../public/imgs/59204060_1515395398594811_7413836574650687457_n.jpg"alt="news"></a>
            </div>
            <div class="title-new">
        ...
        <div class="item-new">
            ...
            <div>
              <a href="#"><img class="img-news" 
                src="../public/imgs/banner-menu-post2.jpg"alt="news"></a>
            </div>
            <div class="title-new">
